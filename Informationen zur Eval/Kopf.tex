...
\documentclass[a4paper, parskip=half, numbers=noenddot, ngerman, fleqn, 9pt]{scrartcl}
\usepackage{babel}
...
\usepackage{bbding} %Für die Schere
...
\newcommand{\Veranstaltung}[1]{\newcommand{\getVeranstaltung}{#1\xspace}}
\newcommand{\Lesender}[1]{\newcommand{\getLesender}{#1\xspace}}
\newcommand{\Semester}[1]{\newcommand{\getSemester}{#1\xspace}}
\newcommand{\Ubungsleiter}[1]{\newcommand{\getUbungsleiter}{#1\xspace}}
...
\minisec{Freitextantworten} %\vspace{0pt minus 5pt}
